...
@st.cache_data
def test_feature_engineering(dataframe):
    """
...
@st.cache_data
def test_prepare_data(dataframe):
    """
...
@st.cache_data
def test_split_train_val(dataframe, frac=0.99):
    """
...
@st.cache_data
def test_training_prophet(dataframe):
    """
...
@st.cache_data
def test_prophet_predict(train_set, val_set, _trained_model):
    """
...
@st.cache_data
def test_predict_col(dataframe, dataframe2, colname):
    """
...
@st.cache_data
def test_predict_col_class(dataframe, dataframe2, colname):
    """
...
def test_calculate_atr(data, window=5):
  """
